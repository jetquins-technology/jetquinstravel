...
export const metadata = {
  ...
  description: "Find the cheapest flight tickets with JetQuinsTravels ! Compare prices effortlessly and book the best deals on flights through our advanced algorithm. Start saving on your next trip today",
  icons: {
    icon: '/favicon.ico'
  }
};
