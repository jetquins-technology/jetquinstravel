        ...
        <>
            <div className="body-content">
                <div className="information_popup hidden-xs" style={{ display: "none" }}>
                    ...
                    <h3>Your data is safe with JetQuinsTravel.com</h3>
                    <ul>
                        <li>
              ...
              `}
                ...
                {/* <section className="serviceBox">
                    <div className="container">
                        <div className="boxService">
                            <div className="box">
                                <div className="icons">
                                    <img src="/Content/images/serviceIcon1.png" />
                                </div>
                                <p>
                                    24-Hour
                                    <br />
                            ...
                            <div className="box">
                                <div className="icons">
                                    <img src="/Content/images/serviceIcon2.png" />
                                </div>
                                <p>
                                    Immediate
                                    <br />
                            ...
                            <div className="box">
                                <div className="icons">
                                    <img src="/Content/images/serviceIcon4.png" />
                                </div>
                                <p>
                                    Flexible Payment
                                    <br />
                            ...
                            <div className="box">
                                <div className="icons">
                                    <img src="/Content/images/serviceIcon3.png" />
                                </div>
                                <p>
                                    ...
                                    <div className="review-block">
                                        <div className="review-content">
                                            ...
                                            <p className="txt">
                                                ...
                                                Somehow I got in contact with a JetQuinsTravel representative
                                                ...
                                                itinerary. And this when I noticed it was from JetQuinsTravel
                                                ...
                                                JetQuinsTravel with more information like the flight
                                                confirmation code. Shortly after I received a call from
                                                JetQuinsTravel, a gentleman named Jonathan. This
                                                ...
                                                actually say I was taken care of by JetQuinsTravel
                ...
                <div className="contentBox">
                    <div className="container">
                        <br />
                        <p>
                            A one-stop site for all your travel needs, JetQuinsTravel is an OTA
                            ...
                            book cheap air tickets with JetQuinsTravel and save big on your ticket
                            reservation.
                        </p>
                        <p>
